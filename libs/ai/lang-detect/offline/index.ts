 ...
 */
export async function detectLanguageOffline(text: string): Promise<LangResult> {
 ...
 */
function containsDarijaWords(text: string): boolean {
 ...
 */
function countDarijaLatinWords(words: string[]): number {
  const darijaLatinWords = darijaWords as string[];
