...
describe('Widget SalamBot - Détection de langue', () => {
    ...
    it('devrait détecter le français et mettre à jour le store', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { detectLanguage } = yield import('@salambot/ai/lang-detect');
        // Simuler la détection
        const detectionResult = yield detectLanguage('bonjour comment ça va');
    ...
    it('devrait détecter l\'arabe et mettre à jour le store', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { detectLanguage } = yield import('@salambot/ai/lang-detect');
        // Simuler la détection
        const detectionResult = yield detectLanguage('مرحبا كيف حالك');
        // Mettre à jour le store
        act(() => {
            result.current.setDetectionResult(detectionResult);
        });
    ...
    it('devrait détecter le darija en alphabet latin et mettre à jour le store', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { detectLanguage } = yield import('@salambot/ai/lang-detect');
        // Simuler la détection
        const detectionResult = yield detectLanguage('labas 3lik khouya');
        // Mettre à jour le store
        act(() => {
            result.current.setDetectionResult(detectionResult);
        });
