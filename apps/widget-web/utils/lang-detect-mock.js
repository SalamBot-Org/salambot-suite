/**
 * @file        Mock local du module de détection de langue pour le widget SalamBot.
...
export function detectLanguage(text) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const frKeywords = ['bonjour', 'merci', 'comment', 'salut', 'je', 'tu', 'nous', 'vous'];
        const arKeywords = ['مرحبا', 'شكرا', 'كيف', 'السلام', 'أنا', 'أنت', 'نحن', 'أنتم'];
        const darijaKeywords = ['labas', 'wach', 'chno', 'kifach', '3lik', 'bghit', 'dyal', 'zwin'];
