...
describe('Agent Desk - Détection de langue et escalade', () => {
    ...
    it('devrait détecter le français et mettre à jour le store', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield act(() => __awaiter(void 0, void 0, void 0, function* () {
            yield convResult.current.detectLanguageFromMessage(conversationId, 'bonjour comment ça va');
        }));
    ...
    it('devrait détecter l\'arabe et mettre à jour le store', () => __awaiter(void 0, void 0, void 0, function* () {
        const { result } = renderHook(() => useLanguageStore());
        const { result: convResult } = renderHook(() => useConversationStore());
        // Créer une conversation
        ...
        // Simuler la détection de langue depuis un message
        yield act(() => __awaiter(void 0, void 0, void 0, function* () {
            yield convResult.current.detectLanguageFromMessage(conversationId, 'مرحبا كيف حالك');
        }));
        // Vérifier que le store de langue a été mis à jour
    ...
    it('devrait détecter le darija en alphabet latin et mettre à jour le store', () => __awaiter(void 0, void 0, void 0, function* () {
        const { result } = renderHook(() => useLanguageStore());
        const { result: convResult } = renderHook(() => useConversationStore());
        // Créer une conversation
        ...
        // Simuler la détection de langue depuis un message
        yield act(() => __awaiter(void 0, void 0, void 0, function* () {
            yield convResult.current.detectLanguageFromMessage(conversationId, 'labas 3lik khouya');
        }));
        // Vérifier que le store de langue a été mis à jour
...
//# sourceMappingURL=language-detection.spec.js.map