/**
 * @file        Types pour le dashboard analytique de l'Agent Desk SalamBot.
...
/**
 * Métadonnées de la réponse de l'API
 */
...
/**
 * Réponse complète de l'API pour les statistiques d'aperçu
 */
